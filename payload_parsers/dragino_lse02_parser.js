  ...
  try {
        ...
        if(port==0x02){
          ...
          if((value & 0x8000)>>15 === 0)
            ...
            decode.temp_SOIL=parseFloat(((value-0x10000)/100).toFixed(2)); // [CLEANFIX 2026-07-02] two's-complement -0x10000
            ...
            data.push({ variable: 'conduct_soil1',  value: parseFloat(decode.conduct_SOIL), unit: 'µS/cm'}); // [CLEANFIX 2026-07-02] was 'mS/m' — LSE01/se0x emit µS/cm for the same raw register; unified
          ...
          if((value & 0x8000)>>15 === 0)
            ...
            decode.temp_SOIL2=parseFloat(((value-0x10000)/100).toFixed(2)); // [CLEANFIX 2026-07-02] two's-complement -0x10000
            ...
            data.push({ variable: 'conduct_soil2',  value: parseFloat(decode.conduct_SOIL2), unit: 'µS/cm'}); // [CLEANFIX 2026-07-02] was 'mS/m' — unified to µS/cm
            }
          else
          {
