...
// ── [SOIL-DEPTH VARIANT — DEEP / Βαθύ] ─────────────────────────────────────────────
// Pins this single-sensor lse01 probe to soil depth slot 2, so two single-sensor
...
// device whose `type` tag is set to lse01_deep (the create/update-field form does that).
(function () {
  var SOIL_DEPTH_RENAME = {
    soil_moisture: 'soil_moisture2',
    temp_soil: 'soil_temperature2',
    conduct_soil: 'conduct_soil2',
  };
