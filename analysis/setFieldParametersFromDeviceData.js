 ...
 ** ορίου (μέγιστο μετρημένο 1.525/1.900). Η v11 (T-CROPKEYS-02) ΔΕΝ ανέβηκε ποτέ.
...
const ROOT_KEYS = [
  ...
  "water_ecw_dsm",
  /* v12 · Φ1: δεύτερο νερό (μείγμα λίπανσης) + ημερομηνίες μέτρησης */
